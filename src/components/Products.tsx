...
return (
<div className="w-full border-b-2 py-16 flex flex-col justify-center bg-[hashtag#F4F5F7] px-4">
...
<button className="text-[16px] font-semibold bg-white py-[12px] px-[72px] text-[#B88E2F] border border-[#B88E2F]">
Show More
</button>
</div>
</div>
